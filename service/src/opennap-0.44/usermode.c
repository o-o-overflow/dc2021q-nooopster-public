/* Copyright (C) 2000-1 edwards@bitchx.dimension6.com
   ...
   $Id: usermode.c,v 1.21 2001/03/06 06:49:53 drscholl Exp $ */
...
unsigned int
set_usermode (char *mode, unsigned int level)
{
    char   *av;
    int     neg = 0;
    int     i, p;

    while ((av = next_arg (&mode)))
    {
